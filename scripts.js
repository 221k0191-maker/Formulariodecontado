...
const generateValueError = (labelName, value) => {
    ...
    // caso radio
    if(value === null){
        error.innerHTML = `${labelName} es requerido`;
        return error
    }
    ...
    if(value.type === 'checkbox'){
        error.innerHTML = `Par enviar este formulario,por favor conciente ser contactado`;
        return error;
    }
...
const createModal = () => {
    ...
    modalContainer.innerHTML = `
        <div class='modal-header'>
            ...
            <h2>Mensaje correcto!</h2>
        </div>
        <p>Gracias por completar este formulario. Nos pondremos en conacto contigo pronto!</p>
    `;
